...
**Reference behavior:** libheif 1.17.6 + libde265 1.0.15 via pillow-heif 1.3.0 / Pillow 12.2.0.
...
**Per-port reference library:**
- Python (reference): pillow-heif 1.3.0 (`pillow_heif.register_heif_opener()`) + Pillow 12.2.0
...
**Fixture corpus:** 10 valid synth fixtures (gradient RGB + RGBA, q50/q90/q100 lossless, various sizes) + 3 invalid (bad-magic, truncated, avif-brand). Generated by `spec/synth_heic.py` using pillow-heif.
