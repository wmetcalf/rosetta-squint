...
echo "  rust:  cd rust/rosetta-image-decode && cargo test --no-fail-fast"
echo "  go:    cd go/imagedecode && go test -count=1 ./..."
echo "  java:  cd java/rosetta-image-decode && mvn -B -ntp test"
echo "  js:    cd js/rosetta-image-decode && npm test"
echo "  swift: cd swift/RosettaImageDecode && swift test"
echo ""
