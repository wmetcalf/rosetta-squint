# rosetta-squint-decode — Rust port
...
```rust
use std::fs;
use rosetta_squint_decode::{decode, detect_format, Channels, DecodeErrorKind};
...
```toml
[dependencies]
rosetta-squint-decode = { path = "../rosetta-squint-decode/rust/rosetta-squint-decode" }
```
