# rosetta-image-decode — Swift port
...
SwiftPM package dependency: [tayloraswift/swift-png](https://github.com/tayloraswift/swift-png) `4.0.0..<4.4.0` for PNG. GIF is a hand-written pure-Swift decoder in `Sources/RosettaImageDecode/Internal/GIFDecoder.swift` (~518 LOC, LZW + 4-pass interlacing).
