...
final class Group2GoldensTests: XCTestCase {
    func testByteExactAllBmp() throws {
        let fixtures = try TestKit.listValidFixtures("bmp")
        XCTAssertEqual(fixtures.count, 30, "expected 30 BMP fixtures")
